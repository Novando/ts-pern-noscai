...
import { Clinic, ListResponse } from '@/app/types/clinic';
import { fetchClinics } from '@/app/services/api';
  ...
  useEffect(() => {
    const loadClinics = async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : 'Failed to load clinics. Please try again later.');
      } finally {
        setIsLoading(false);
      }
    };
